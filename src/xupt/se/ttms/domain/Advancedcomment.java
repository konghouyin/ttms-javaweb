...
public class Advancedcomment {
	...
	public String toString() {
		return "Advancedcomment [comment_id=" + comment_id + ", play_id=" + play_id + ", user_id=" + user_id
				+ ", comment_message=" + comment_message + ", comment_time=" + comment_time + ", comment_grade="
				+ comment_grade + ", comment_status=" + comment_status + ", comment_dateout=" + comment_dateout
				+ ", user_name=" + user_name + "]";
	}
